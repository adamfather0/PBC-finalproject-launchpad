...
class launchpad(tk.Frame):
	...
	def createwidgets(self):
		...
		self.btnnum1_lowKey.bind_all('4', self.threaded_run_1_hiSpd)
		self.btnnum2_lowKey.bind_all('r', self.threaded_run_2_hiSpd)
		self.btnnum3_lowKey.bind_all('f', self.threaded_run_3_hiSpd)
		self.btnnum4_lowKey.bind_all('v', self.threaded_run_4_hiSpd)

		self.btnnum1_lowKey.bind_all('5', self.threaded_run_1_lowSpd)
		self.btnnum2_lowKey.bind_all('t', self.threaded_run_2_lowSpd)
		self.btnnum3_lowKey.bind_all('g', self.threaded_run_3_lowSpd)
		self.btnnum4_lowKey.bind_all('b', self.threaded_run_4_lowSpd)
