...
class launchpad(tk.Frame):
	...
	def createwidgets(self):
		...
		# 原音
		self.btnnum1_origin_gif = tk.PhotoImage(file='C://Users//chtu//Desktop//btn//btn0_1.gif')
		self.btnnum1_origin_change_gif = tk.PhotoImage(file='C://Users//chtu//Desktop//btn//btn0_1c.gif')
		...
		self.btnnum2_origin_gif = tk.PhotoImage(file='C://Users//chtu//Desktop//btn//btn1_1.gif')
		self.btnnum2_origin_change_gif = tk.PhotoImage(file='C://Users//chtu//Desktop//btn//btn1_1c.gif')
		...
		self.btnnum3_origin_gif = tk.PhotoImage(file='C://Users//chtu//Desktop//btn//btn2_1.gif')
		self.btnnum3_origin_change_gif = tk.PhotoImage(file='C://Users//chtu//Desktop//btn//btn2_1c.gif')
		...
		self.btnnum4_origin_gif = tk.PhotoImage(file='C://Users//chtu//Desktop//btn//btn3_1.gif')
		self.btnnum4_origin_change_gif = tk.PhotoImage(file='C://Users//chtu//Desktop//btn//btn3_1c.gif')
		...
		# 升key
		self.btnnum1_hikey_gif = tk.PhotoImage(file='C://Users//chtu//Desktop//btn//btn01.gif')
		self.btnnum1_hikey_change_gif = tk.PhotoImage(file='C://Users//chtu//Desktop//btn//btn01c.gif')
		...
		self.btnnum2_hikey_gif = tk.PhotoImage(file='C://Users//chtu//Desktop//btn//btn11.gif')
		self.btnnum2_hikey_change_gif = tk.PhotoImage(file='C://Users//chtu//Desktop//btn//btn11c.gif')
		...
		self.btnnum3_hikey_gif = tk.PhotoImage(file='C://Users//chtu//Desktop//btn//btn21.gif')
		self.btnnum3_hikey_change_gif = tk.PhotoImage(file='C://Users//chtu//Desktop//btn//btn21c.gif')
		...
		self.btnnum4_hikey_gif = tk.PhotoImage(file='C://Users//chtu//Desktop//btn//btn31.gif')
		self.btnnum4_hikey_change_gif = tk.PhotoImage(file='C://Users//chtu//Desktop//btn//btn31c.gif')
		...
		self.btnnum1_lowKey_change_gif = tk.PhotoImage(file='C://Users//chtu//Desktop//btn//btn02c.gif')
		...
		self.btnnum2_lowKey_change_gif = tk.PhotoImage(file='C://Users//chtu//Desktop//btn//btn12c.gif')
		...
		self.btnnum3_lowKey_change_gif = tk.PhotoImage(file='C://Users//chtu//Desktop//btn//btn22c.gif')
		...
		self.btnnum4_lowKey_change_gif = tk.PhotoImage(file='C://Users//chtu//Desktop//btn//btn32c.gif')
		...
		self.btnnum1_hiSpd_change_gif = tk.PhotoImage(file='C://Users//chtu//Desktop//btn//btn03c.gif')
		...
		self.btnnum2_hiSpd_change_gif = tk.PhotoImage(file='C://Users//chtu//Desktop//btn//btn13c.gif')
		...
		self.btnnum3_hiSpd_change_gif = tk.PhotoImage(file='C://Users//chtu//Desktop//btn//btn23c.gif')
		...
		self.btnnum4_hiSpd_change_gif = tk.PhotoImage(file='C://Users//chtu//Desktop//btn//btn33c.gif')
		...
		self.btnnum1_lowSpd_change_gif = tk.PhotoImage(file='C://Users//chtu//Desktop//btn//btn04c.gif')
		...
		self.btnnum2_lowSpd_change_gif = tk.PhotoImage(file='C://Users//chtu//Desktop//btn//btn14c.gif')
		...
		self.btnnum3_lowSpd_change_gif = tk.PhotoImage(file='C://Users//chtu//Desktop//btn//btn24c.gif')
		...
		self.btnnum4_lowSpd_change_gif = tk.PhotoImage(file='C://Users//chtu//Desktop//btn//btn34c.gif')
	...
	def song1_origin(self):
		self.btnnum1_origin.configure(image="btnnum1_origin_change_gif")
		sampler = Sampler()
		s1 = Sound.from_file(song_name1)
		sampler.play(s1)

	def song1_hikey(self):
		self.btnnum1_hikey.configure(image="btnnum1_hikey_change_gif")
		sampler = Sampler()
		s1 = Sound.from_file(song_name1)
		s1.pitch_shift = 1
		sampler.play(s1)
	...
	def song1_lowKey(self):
		self.btnnum1_lowKey.configure(image="btnnum1_lowKey_change_gif")
		sampler = Sampler()
		s1 = Sound.from_file(song_name1)
		s1.pitch_shift = -1
		sampler.play(s1)
	...
	def song1_hiSpd(self):
		self.btnnum1_hiSpd.configure(image="btnnum1_hiSpd_change_gif")
		sampler = Sampler()
		s1 = Sound.from_file(song_name1)
		s1.stretch_factor = 2
		sampler.play(s1)
	...
	def song1_lowSpd(self):
		self.btnnum1_lowSpd.configure(image="btnnum1_lowSpd_change_gif")
		sampler = Sampler()
		s1 = Sound.from_file(song_name1)
	...
	def song2_origin(self):
		self.btnnum2_origin.configure(image="btnnum2_origin_change_gif")
		sampler = Sampler()
		s2 = Sound.from_file(song_name2)
		sampler.play(s2)

	def song2_hikey(self):
		self.btnnum2_hikey.configure(image="btnnum2_hikey_change_gif")
		sampler = Sampler()
		s2 = Sound.from_file(song_name2)
		s2.pitch_shift = 1
		sampler.play(s2)
	...
	def song2_lowKey(self):
		self.btnnum2_lowKey.configure(image="btnnum2_lowKey_change_gif")
		sampler = Sampler()
		s2 = Sound.from_file(song_name2)
		s2.pitch_shift = -1
		sampler.play(s2)
	...
	def song2_hiSpd(self):
		self.btnnum2_hiSpd.configure(image="btnnum2_hiSpd_change_gif")
		sampler = Sampler()
		s2 = Sound.from_file(song_name2)
		s2.stretch_factor = 2
		sampler.play(s2)
	...
	def song2_lowSpd(self):
		self.btnnum2_lowSpd.configure(image="btnnum2_lowSpd_change_gif")
		sampler = Sampler()
		s2 = Sound.from_file(song_name2)
	...
	def song3_origin(self):
		self.btnnum3_origin.configure(image="btnnum3_origin_change_gif")
		sampler = Sampler()
		s3 = Sound.from_file(song_name3)
		sampler.play(s3)

	def song3_hikey(self):
		self.btnnum3_hikey.configure(image="btnnum3_hikey_change_gif")
		sampler = Sampler()
		s3 = Sound.from_file(song_name3)
		s3.pitch_shift = 1
		sampler.play(s3)
	...
	def song3_lowKey(self):
		self.btnnum3_lowKey.configure(image="btnnum3_lowKey_change_gif")
		sampler = Sampler()
		s3 = Sound.from_file(song_name3)
		s3.pitch_shift = -1
		sampler.play(s3)
	...
	def song3_hiSpd(self):
		self.btnnum3_hiSpd.configure(image="btnnum3_hiSpd_change_gif")
		sampler = Sampler()
		s3 = Sound.from_file(song_name3)
		s3.stretch_factor = 2
		sampler.play(s3)
	...
	def song3_lowSpd(self):
		self.btnnum3_lowSpd.configure(image="btnnum3_lowSpd_change_gif")
		sampler = Sampler()
		s3 = Sound.from_file(song_name3)
	...
	def song4_origin(self):
		self.btnnum4_origin.configure(image="btnnum4_origin_change_gif")
		sampler = Sampler()
		s4 = Sound.from_file(song_name4)
		sampler.play(s4)

	def song4_hikey(self):
		self.btnnum4_hikey.configure(image="btnnum4_hikey_change_gif")
		sampler = Sampler()
		s4 = Sound.from_file(song_name4)
		s4.pitch_shift = 1
		sampler.play(s4)
	...
	def song4_lowKey(self):
		self.btnnum4_lowKey.configure(image="btnnum4_lowKey_change_gif")
		sampler = Sampler()
		s4 = Sound.from_file(song_name4)
		s4.pitch_shift = -1
		sampler.play(s4)
	...
	def song4_hiSpd(self):
		self.btnnum4_hiSpd.configure(image="btnnum4_hiSpd_change_gif")
		sampler = Sampler()
		s4 = Sound.from_file(song_name4)
		s4.stretch_factor = 2
		sampler.play(s4)
	...
	def song4_lowSpd(self):
		self.btnnum4_lowSpd.configure(image="btnnum4_lowSpd_change_gif")
		sampler = Sampler()
		s4 = Sound.from_file(song_name4)
