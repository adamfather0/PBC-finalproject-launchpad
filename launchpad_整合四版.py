...
class launchpad(tk.Frame):
    ...
    def createwidgets(self):
		...
		#四個標籤
        self.txtnum1 = tk.Label(self,text ='origin', height = 1, width = 10,font = f1)
        self.txtnum2 = tk.Label(self,text ='pitchup', height = 1, width = 10,font = f1)
        self.txtnum3 = tk.Label(self,text ='pitchdn', height = 1, width = 10,font = f1)
        self.txtnum4 = tk.Label(self,text ='speedup', height = 1, width = 10,font = f1)
        self.txtnum5 = tk.Label(self,text ='speeddn', height = 1, width = 10,font = f1)
        # 四個輸入歌曲按鍵
        ...
        # 原音
        self.btnnum1_origin_gif = tk.PhotoImage(file='D://USER//desktop//btn//btn0_1.gif')
        self.btnnum1_origin_change_gif = tk.PhotoImage(file='D://USER//desktop//btn//btn0_1c.gif')
        ...
        self.btnnum2_origin_gif = tk.PhotoImage(file='D://USER//desktop//btn//btn1_1.gif')
        self.btnnum2_origin_change_gif = tk.PhotoImage(file='D://USER//desktop//btn//btn1_1c.gif')
        ...
        self.btnnum3_origin_gif = tk.PhotoImage(file='D://USER//desktop//btn//btn2_1.gif')
        self.btnnum3_origin_change_gif = tk.PhotoImage(file='D://USER//desktop//btn//btn2_1c.gif')
        ...
        self.btnnum4_origin_gif = tk.PhotoImage(file='D://USER//desktop//btn//btn3_1.gif')
        self.btnnum4_origin_change_gif = tk.PhotoImage(file='D://USER//desktop//btn//btn3_1c.gif')
        ...
        # 升key
        self.btnnum1_hikey_gif = tk.PhotoImage(file='D://USER//desktop//btn//btn01.gif')
        self.btnnum1_hikey_change_gif = tk.PhotoImage(file='D://USER//desktop//btn//btn01c.gif')
        ...
        self.btnnum2_hikey_gif = tk.PhotoImage(file='D://USER//desktop//btn//btn11.gif')
        self.btnnum2_hikey_change_gif = tk.PhotoImage(file='D://USER//desktop//btn//btn11c.gif')
        ...
        self.btnnum3_hikey_gif = tk.PhotoImage(file='D://USER//desktop//btn//btn21.gif')
        self.btnnum3_hikey_change_gif = tk.PhotoImage(file='D://USER//desktop//btn//btn21c.gif')
        ...
        self.btnnum4_hikey_gif = tk.PhotoImage(file='D://USER//desktop//btn//btn31.gif')
        self.btnnum4_hikey_change_gif = tk.PhotoImage(file='D://USER//desktop//btn//btn31c.gif')
        ...
        # 降key
        self.btnnum1_lowKey_gif = tk.PhotoImage(file='D://USER//desktop//btn//btn02.gif')
        self.btnnum1_lowKey_change_gif = tk.PhotoImage(file='D://USER//desktop//btn//btn02c.gif')
        ...
        self.btnnum2_lowKey_gif = tk.PhotoImage(file='D://USER//desktop//btn//btn12.gif')
        self.btnnum2_lowKey_change_gif = tk.PhotoImage(file='D://USER//desktop//btn//btn12c.gif')
        ...
        self.btnnum3_lowKey_gif = tk.PhotoImage(file='D://USER//desktop//btn//btn22.gif')
        self.btnnum3_lowKey_change_gif = tk.PhotoImage(file='D://USER//desktop//btn//btn22c.gif')
        ...
        self.btnnum4_lowKey_gif = tk.PhotoImage(file='D://USER//desktop//btn//btn32.gif')
        self.btnnum4_lowKey_change_gif = tk.PhotoImage(file='D://USER//desktop//btn//btn32c.gif')
        ...
        # 升速
        self.btnnum1_hiSpd_gif = tk.PhotoImage(file='D://USER//desktop//btn//btn03.gif')
        self.btnnum1_hiSpd_change_gif = tk.PhotoImage(file='D://USER//desktop//btn//btn03c.gif')
        ...
        self.btnnum2_hiSpd_gif = tk.PhotoImage(file='D://USER//desktop//btn//btn13.gif')
        self.btnnum2_hiSpd_change_gif = tk.PhotoImage(file='D://USER//desktop//btn//btn13c.gif')
        ...
        self.btnnum3_hiSpd_gif = tk.PhotoImage(file='D://USER//desktop//btn//btn23.gif')
        self.btnnum3_hiSpd_change_gif = tk.PhotoImage(file='D://USER//desktop//btn//btn23c.gif')
        ...
        self.btnnum4_hiSpd_gif = tk.PhotoImage(file='D://USER//desktop//btn//btn33.gif')
        self.btnnum4_hiSpd_change_gif = tk.PhotoImage(file='D://USER//desktop//btn//btn33c.gif')
        ...
        # 降速
        self.btnnum1_lowSpd_gif = tk.PhotoImage(file='D://USER//desktop//btn//btn04.gif')
        self.btnnum1_lowSpd_change_gif = tk.PhotoImage(file='D://USER//desktop//btn//btn04c.gif')
        ...
        self.btnnum2_lowSpd_gif = tk.PhotoImage(file='D://USER//desktop//btn//btn14.gif')
        self.btnnum2_lowSpd_change_gif = tk.PhotoImage(file='D://USER//desktop//btn//btn14c.gif')
        ...
        self.btnnum3_lowSpd_gif = tk.PhotoImage(file='D://USER//desktop//btn//btn24.gif')
        self.btnnum3_lowSpd_change_gif = tk.PhotoImage(file='D://USER//desktop//btn//btn24c.gif')
        ...
        self.btnnum4_lowSpd_gif = tk.PhotoImage(file='D://USER//desktop//btn//btn34.gif')
        self.btnnum4_lowSpd_change_gif = tk.PhotoImage(file='D://USER//desktop//btn//btn34c.gif')
        ...
        # 按鍵排版
        self.txtnum1.grid(row = 0, column = 1,sticky = tk.NE + tk.SW)
        self.txtnum2.grid(row = 0, column = 2,sticky = tk.NE + tk.SW)
        self.txtnum3.grid(row = 0, column = 3,sticky = tk.NE + tk.SW)
        self.txtnum4.grid(row = 0, column = 4,sticky = tk.NE + tk.SW)
        self.txtnum5.grid(row = 0, column = 5,sticky = tk.NE + tk.SW)
        ...
        self.btnnum4.grid(row=4, column=0, sticky=tk.NE + tk.SW)

        self.btnnum1_origin.grid(row=1, column=1, sticky=tk.NE + tk.SW)
        self.btnnum2_origin.grid(row=2, column=1, sticky=tk.NE + tk.SW)
        self.btnnum3_origin.grid(row=3, column=1, sticky=tk.NE + tk.SW)
        self.btnnum4_origin.grid(row=4, column=1, sticky=tk.NE + tk.SW)

        self.btnnum1_hikey.grid(row=1, column=2, sticky=tk.NE + tk.SW)
        self.btnnum2_hikey.grid(row=2, column=2, sticky=tk.NE + tk.SW)
        self.btnnum3_hikey.grid(row=3, column=2, sticky=tk.NE + tk.SW)
        self.btnnum4_hikey.grid(row=4, column=2, sticky=tk.NE + tk.SW)

        self.btnnum1_lowKey.grid(row=1, column=3, sticky=tk.NE + tk.SW)
        self.btnnum2_lowKey.grid(row=2, column=3, sticky=tk.NE + tk.SW)
        self.btnnum3_lowKey.grid(row=3, column=3, sticky=tk.NE + tk.SW)
        self.btnnum4_lowKey.grid(row=4, column=3, sticky=tk.NE + tk.SW)

        self.btnnum1_hiSpd.grid(row=1, column=4, sticky=tk.NE + tk.SW)
        self.btnnum2_hiSpd.grid(row=2, column=4, sticky=tk.NE + tk.SW)
        self.btnnum3_hiSpd.grid(row=3, column=4, sticky=tk.NE + tk.SW)
        self.btnnum4_hiSpd.grid(row=4, column=4, sticky=tk.NE + tk.SW)

        self.btnnum1_lowSpd.grid(row=1, column=5, sticky=tk.NE + tk.SW)
        self.btnnum2_lowSpd.grid(row=2, column=5, sticky=tk.NE + tk.SW)
        self.btnnum3_lowSpd.grid(row=3, column=5, sticky=tk.NE + tk.SW)
        self.btnnum4_lowSpd.grid(row=4, column=5, sticky=tk.NE + tk.SW)
...
root.iconbitmap('D://USER//desktop//btn//1.ico')
window.mainloop()